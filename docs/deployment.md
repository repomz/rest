...
Команда проверяет последний release `github.com/repomz/rest_generator`, скачивает подходящий архив для текущей ОС/архитектуры и заменяет текущий исполняемый файл `rest`.
